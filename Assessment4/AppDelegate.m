...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    // Check if the default (InitialDogOwners.plist) was loaded to CoreData
    NSString *plistName = @"InitialDogOwners.plist";
    ...
    if (!fileExists)
    {
        ...
        {
            NSManagedObject *character = [NSEntityDescription insertNewObjectForEntityForName:@"Person" inManagedObjectContext:self.managedObjectContext];
            [character setValue:person forKey:@"name"];
